...
const FreeTrial = () => {
  return (
    <div className="w-full bg-[#E0E9F3]">
      <div
        className="max-w-[1920px] w-full mx-auto overflow-hidden flex 
      ...
      >
        <div className="max-w-[1086px] w-full py-[65px] desktop:py-[105px] tablet:py-[75px] flex flex-col items-center">
          ...
          <div
            className="text-[18px] text-[#3C3E41] mt-[48px]  px-11 tablet:w-[600px] text-center flex justify-center 
                    mobile:leading-[32px] leading-[48px] font-variation-customOpt18"
          >
            <div className="flex mobile:hidden">
              Brezplačna izdelava. Brezplačna domena in gostovanje. Brezplačno
              testiranje 45 dni. Brez pogodbe.
            </div>

            <div className="hidden mobile:flex flex-col mx-auto ">
              <div>Brezplačna izdelava.</div>

              <div className="whitespace-nowrap">
                Brezplačna domena in gostovanje.
              </div>

              <div>Brezplačno testiranje 45 dni.</div>
              <div>Brez pogodbe.</div>
            </div>
          </div>
        </div>
      </div>
